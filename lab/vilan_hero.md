## DOM Implementation.
Remember our superheroes function from last week. This week we are going to modify it do a little bit more.

I want to assume, your `superHeroes` function returns an object with the following:
1. `add` to add new superheros,
1. `getAll` to get all heros
1. `print` to print all to console.

Look and study the object below, understand its keys and values.
